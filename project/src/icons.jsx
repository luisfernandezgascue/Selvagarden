// Custom line icons — keeps premium feel; no emoji in chrome
const Icon = {
  Home: (p={}) => (
  ...
  Pin: (p={}) => (
    <svg width={p.size||16} height={p.size||16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={p.weight||1.6} strokeLinecap="round" strokeLinejoin="round">
...
// Selva brand leaf — abstracted from logo pictogram
function SelvaLeaf({ size=20, color='#fff' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path d="M12 3.2 C 9.2 5.6, 7.8 8.8, 7.8 12.4 L 12 13 L 16.2 12.4 C 16.2 8.8, 14.8 5.6, 12 3.2 Z"
            fill={color}/>
...
// Google / Apple glyphs for sign-in
function GoogleG() {
  return (
...
Object.assign(window, { Icon, SelvaLeaf, GoogleG, AppleA });
