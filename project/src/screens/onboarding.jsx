...
// Screen 1: Welcome with editorial plant photo
function OnboardWelcome() {
  return (
    <Phone statusBarDark={true} homeLight={true}>
...
// Screen 2: Sign-up with 3 fields + social
function OnboardSignup() {
  return (
    <Phone>
      <div className="scroll" style={{ padding:'10px 24px 24px' }}>
        <button style={{ background:'none', border:'none', padding:0, color:'#1A1A1A', marginBottom:32 }}>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:10, marginBottom:22 }}>
          ...
          <button style={socialBtn}>
            <AppleA/> <span>Continuar con Apple</span>
          </button>
        </div>
...
// Screen 3: QR card ready
function OnboardCardReady() {
  return (
    <Phone>
      <div className="scroll" style={{ padding:'10px 24px 30px', display:'flex', flexDirection:'column' }}>
        ...
        <button style={{
          ...
          color:'#888', fontSize:12, padding:'8px',
        }}>Añadir a Apple Wallet</button>
      </div>
    </Phone>
  );
}

Object.assign(window, { OnboardWelcome, OnboardSignup, OnboardCardReady });
