  ...
  return (
    <Phone>
      <div className="scroll">
        ...
        {/* Échale Tierra — referral hero */}
        <div style={{
          margin:'14px 14px 0', padding:'20px 18px',
          background:'linear-gradient(135deg, #F5EDD8 0%, #FBF6ED 70%)',
          ...
          <div style={{
            ...
            background:'rgba(255,255,255,0.7)', borderRadius:12, padding:'9px 12px',
            border:'1px dashed rgba(181,135,58,0.3)',
            position:'relative',
          }}>
            <span style={{ fontFamily:'var(--font-mono)', fontSize:11, color:'#1A3C2E', flex:1, overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>
              selva.garden/r/carlos
            </span>
            <button style={{
              background:'#1A3C2E', color:'#F5EDD8', border:'none',
              borderRadius:18, padding:'6px 12px', fontSize:11, fontWeight:600,
        ...
        <div style={{ padding:'0 14px' }}>
          <div style={{ background:'#1A3C2E', borderRadius:16, padding:16, color:'#fff', position:'relative', overflow:'hidden' }}>
            ...
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'baseline', marginBottom:14, position:'relative' }}>
              ...
              <span className="chip chip-gold" style={{ background:'rgba(245,237,216,0.18)', color:'#F5EDD8', borderColor:'rgba(245,237,216,0.35)' }}>Nivel · Embajador</span>
            </div>
            {/* sparkline */}
...
function MenuRow({ icon, text, sub }) {
  return (
    <button style={{
