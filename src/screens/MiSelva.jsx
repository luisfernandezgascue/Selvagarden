    ...
    <Phone>
      ...
      <div className="scroll">
        ...
        <div style={{ padding: '4px 18px 22px', display: 'flex', alignItems: 'center', gap: 14 }}>
          <div style={{ width: 44, height: 44, borderRadius: '50%', background: '#2D5A3D', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: '0 2px 10px rgba(45,90,61,0.3)' }}><img src="/brand/SelvaGarden_pictograma_oscuro_512.png" alt="Selva" style={{ width: 26, height: 26, objectFit: 'contain' }}/></div>
          <div>
