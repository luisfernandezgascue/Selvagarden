...
export default function Home({ onTab, onProduct }) {
  ...
  return (
    <Phone>
      <div style={{ flexShrink: 0, padding: '4px 0px 12px 4px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <img src="/brand/SelvaGarden_horizontal_claro.svg?v=6" alt="Selva Garden" className="header-logo" style={{ height: '72px', width: 'auto', display: 'block', flexShrink: 0, marginLeft: '-20px' }}/>
